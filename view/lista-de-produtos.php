                                                ...
                                                <div class="product-item-body">
                                                    ...
                                                    <p class="mt-3">
                                                        <?php if (isset($_SESSION['usuario_logado'])) { ?>
                                                            <button class="btn btn-outline-primary btn-carrinho" id="btn-carrinho-<?= $produto['id'] ?>" style="cursor: <?= $produto['carrinho'] === true ? 'not-allowed' : 'pointer' ?>;" data-id="<?= $produto['id'] ?>" <?= $produto['carrinho'] === true ? 'disabled' : '' ?>><i class="icofont icofont-shopping-cart"></i> Adicionar ao carrinho</button>
                                                        <?php } else { ?>
