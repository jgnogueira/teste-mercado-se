...
<head>
    ...
    <title>Mercado SoftExpert - Cadastrar Tipo de Produto</title>
    <style>
        html {
            height: 100%;
            min-height: 100%;
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Cadastrar Tipo de Produto</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <script src="assets/js/cadastrar-tipo-produto.js"></script>
    <script>
        $(document).ready(function() {
            $('#cadastrar-tipo-produto').addClass('active');
        });
    </script>
</body>
